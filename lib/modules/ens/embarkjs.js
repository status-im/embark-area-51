...
__embarkENS.resolve = function (name, callback) {
  ...
  ENSFunctions.resolveName(name, this.ens, createResolverContract, callback);
};
...
__embarkENS.lookup = function (address, callback) {
  ...
  return ENSFunctions.lookupAddress(address, this.ens, web3.utils, createResolverContract.bind(this), callback);
};
...
__embarkENS.registerSubDomain = function (name, address, callback) {
  ...
  ENSFunctions.registerSubDomain(this.ens, this.registrar, this.resolver, web3.eth.defaultAccount,
